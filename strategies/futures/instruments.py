...
FUTURES_INSTRUMENTS = {
    ...
    "MES": FuturesInstrument("MES","ES=F","ES",5.0,0.25,1.25,(10.0,20.0),"Micro E-mini S&P 500"),
    "NQ": FuturesInstrument("NQ","NQ=F","NQ",20.0,0.25,5.00,(10.0,18.0),"E-mini Nasdaq-100"),
    "MNQ": FuturesInstrument("MNQ","NQ=F","NQ",2.0,0.25,0.50,(10.0,18.0),"Micro E-mini Nasdaq-100"),
    ...
    "MGC": FuturesInstrument("MGC","GC=F","GC",10.0,0.10,1.0,(7.0,12.0),"Micro Gold"),
    "SI": FuturesInstrument("SI","SI=F","SI",5000.0,0.005,25.0,(4.0,8.0),"COMEX Silver"),
    "SIL": FuturesInstrument("SIL","SI=F","SI",1000.0,0.001,1.0,(4.0,8.0),"Micro Silver"),
    "CL": FuturesInstrument("CL","CL=F","CL",1000.0,0.01,10.0,(7.0,15.0),"WTI Crude Oil"),
    "MCL": FuturesInstrument("MCL","CL=F","CL",100.0,0.01,1.0,(7.0,15.0),"Micro WTI Crude Oil"),
    "NG": FuturesInstrument("NG","NG=F","NG",10000.0,0.001,10.0,(5.0,12.0),"Henry Hub Natural Gas"),
    "MNG": FuturesInstrument("MNG","NG=F","NG",1000.0,0.001,1.0,(5.0,12.0),"Micro Henry Hub Natural Gas"),
