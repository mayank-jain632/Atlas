...
class BaseMomentumStrategy(BaseStrategy):
    ...
    def __init__(
        ...
        universe_root: str | Path = "config/universes",
        ...
        # This supports either the original EMS default path or
        # the newer DataInterface default path.
        ...
        if not self.stock_universe:
            raise ValueError(
                f"Universe '{self.universe_name}' is empty."
            )
